...
double getLeftLidar() {
	...
	//is 4 in away from the point. Add .0833 ft for each inch the lens is mounted further
	//from the center of the car. Likewise, subtract .0833 ft for each inch the lens is mounted
	//closer to the center of the car.
	//Uncertainty is about 1 in
	return (LIDAR_VALUE_LEFT*.0000261379)-.130335;
}

double getRightLidar() {
	return (LIDAR_VALUE_RIGHT*.0000261379)-.130335;
}
